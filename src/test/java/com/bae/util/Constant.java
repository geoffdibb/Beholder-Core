...
public class Constant {
	...
	public static final AuditRequestLog MOCK_USER_OBJECT = new AuditRequestLog("user1", 1);
	public static final AuditRequestLog MOCK_USER_OBJECT2 = new AuditRequestLog("user2", 2);
